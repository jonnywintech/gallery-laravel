window.addEventListener("load", function () {
    ...
    addButton.addEventListener("click", () => {
        ...
        container.insertAdjacentHTML("afterbegin", createImage(totalImages));
    ...
    function reloadButtons() {
        // it cleans excess event listeners when a new image is created
    ...
    function createImage(imagePosition) {
        return `
            <div class="col">
